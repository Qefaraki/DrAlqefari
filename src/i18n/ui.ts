...
export const ui = {
  ar: {
    ...
    'meta.description': 'مستشار ومهداف تنفيذي دولي في التخطيط الاستراتيجي وبناء الأصول والثروات، أستاذ جامعي وخبير في ريادة الأعمال، أكثر من 15 عاماً من الخبرة بين لندن ودول الخليج',
    ...
    'about.bioDetailed': 'خبير ومستشار دولي متخصص في تقديم جلسات المهداف التنفيذي للنخبة من الأسر الثرية، ورواد الأعمال، والمشاهير، والرياضيين، والقيادات الحكومية. يعمل الدكتور عبدالله القفاري أستاذاً مشاركاً بجامعة الإمام محمد بن سعود الإسلامية بالرياض، ويجمع بين العمق الأكاديمي والخبرة التطبيقية في مجالات التخطيط الاستراتيجي، القيادة، ريادة الأعمال، وبناء الأصول والثروات المستدامة.',
    ...
    'cv.education.1': 'دكتوراه في برامج الموهوبين، جامعة برونيل، لندن (2010)',
    'cv.education.2': 'ماجستير في القانون التجاري الدولي، جامعة لانكشاير، بريطانيا',
    'cv.education.3': 'ماجستير في الدراسات الاجتماعية، جامعة الملك سعود',
    'cv.education.4': 'دبلوم عالٍ في التمويل والأمان البنكي، جامعة لوفبرا، بريطانيا',
    'cv.education.5': 'بكالوريوس في الشريعة، جامعة الإمام محمد بن سعود الإسلامية',
    'cv.education.6': 'بكالوريوس في الخدمة الاجتماعية، جامعة الإمام محمد بن سعود الإسلامية',
    'cv.training.title': 'الشهادات الاحترافية المتخصصة',
    'cv.training.realEstate.title': 'ماستر في التطوير والاستثمار العقاري، بريطانيا',
    ...
    'cv.training.coaching.title': 'ماستر مهداف معتمد من The Coaching Academy، بريطانيا',
    ...
    'faq.4.a': 'دعم وتوجيه العميل في تحقيق أهدافه من خلال بناء علاقة قائمة على الثقة والاحترام المتبادل. المهداف يستمع بعمق، يطرح أسئلة قوية، ويساعد العميل على رؤية الأمور من زوايا جديدة.',
    ...
    'faq.18.a': 'لا، يحضر الجلسات المهداف الدكتور القفاري فقط، مع ضمان سرية تامة لجميع المعلومات التي يتم مشاركتها خلال الجلسات.',
    ...
    'faq.23.a': 'عدم التفرغ الكامل للجلسات، صعوبة تحديد الأهداف بوضوح في البداية، ومقاومة التغيير. المهداف يساعد في التغلب على هذه التحديات بصبر واحترافية.',
